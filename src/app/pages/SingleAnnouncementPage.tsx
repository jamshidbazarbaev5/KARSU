...
export default function SingleAnnouncementPage() {
  ...
  const getTranslatedText = (translations: any, language: string, field: string) => {
            ...
            <div className="main-event-info">
              <div 
                ...
                dangerouslySetInnerHTML={{
                  __html: getTranslatedText(announcement.translations, i18n.language, 'description')
                }}
              />
            </div>
            <div className="main-event-date">
              <span className="main-event-date-span">
                {new Date(announcement.date_post).toLocaleDateString(i18n.language, {
                  year: 'numeric',
                  month: 'long',
                  day: 'numeric'
                })}
